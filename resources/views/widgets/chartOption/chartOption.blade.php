...
<div class="col-md-12 col-xs-12 marg-top-title">
    ...
    <div class="col-md-3 col-xs-12">
        <input type="radio" name="view" value="1" id="rdMIP" onchange="viewByMIP();" checked><label class="padding-left-1-10">Tháng - Điểm thực hiện - Điểm chuẩn</label>
    </div>
    <div class="col-md-3 col-xs-12" id="divRdGTI">
        <input type="radio" name="view" value="2" id="rdGTI" onchange="viewByGoalTargetImplement();"><label class="padding-left-1-10">Mục tiêu - Kế hoạch - Thực hiện</label>
    </div>
    <div class="col-md-4 col-xs-12">
        <input type="radio" name="view" value="3" id="rdGBMIP" onchange="viewByGBMIP();" ><label class="padding-left-1-10">Mục tiêu - Điểm thực hiện - Điểm chuẩn</label>
    </div>
</div>
...
<script>
    ...
    function viewByGoalTargetImplement() {
        showData();
    }
