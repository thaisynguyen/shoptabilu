<div class="col-md-12 col-xs-12 margin-top-chart">
    ...
    <div class="col-md-3 col-xs-12">
        <input type="radio" name="charts" id="rdPieChart" onchange="viewPie();"><label class="padding-left-1-10">Biểu đồ bánh</label>
    </div>
</div>
...
<script>
    ...
    function paintChartPieBMIP(data, labelIP, title, id){
        var node = document.getElementById("idTable");
        while (node.firstChild) {
            node.removeChild(node.firstChild);
        }
