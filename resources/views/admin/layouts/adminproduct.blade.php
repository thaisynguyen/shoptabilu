...
@section('link_css')
	...
	{{ HTML::style('public/assets/admintheme/global/plugins/bootstrap-timepicker/css/bootstrap-timepicker.min.css') }}	
	{{ HTML::style('public/assets/admintheme/global/plugins/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css') }}	
...
<div class="page-header navbar navbar-fixed-top">
    ...
    <div class="page-header-inner ">
        ...
        <div class="page-logo">
            <a href="index.html">
                <img src="{{url('/public/assets/admintheme/layouts/layout/img/logo.png')}}" alt="logo" class="logo-default" /> </a>
...
@section('link_js')
    ...
    {{ HTML::script('public/assets/admintheme/global/plugins/datatables/datatables.js') }}
	...
	{{ HTML::script('public/assets/admintheme/global/plugins/bootstrap-timepicker/js/bootstrap-timepicker.min.js') }}
	{{ HTML::script('public/assets/admintheme/global/plugins/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js') }}	
