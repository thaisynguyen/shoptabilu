    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title text-normal text-bold"><?php echo 'Thêm Mới Đơn Vị Tính';?></h4>
            </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn blue btn-act btn-smooth" id="btnSaveUnit"><?php echo 'Lưu';?></button>
