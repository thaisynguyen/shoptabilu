...
@section('page_heading', 'THỰC HIỆN THEO TỔ/QUẬN/HUYỆN')
@section('section')
            ...
            <div class="col-sm-12">
                ...
                <div class="col-sm-4 form-group">
                    <select class="form-control combobox-99" id="cboCompany"
                            onchange="reloadPageWithParam('{{action('ReportController@reportImplementByArea')}}'
                                    , 'reportImplementByArea'
            ...
            <div class="col-sm-12">
                ...
                <div class="col-sm-2 form-group">
                    <a title="Báo cáo in lưu theo tháng" role="button" id="expGoalArea" class="btn btn-primary "
                       onclick="reloadPageWithParam('{{action('ExportExcelController@exportImplementByArea')}}'
                               , 'exportImplementByArea'
