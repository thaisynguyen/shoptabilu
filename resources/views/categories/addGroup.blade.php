...
@section('page_heading', Config::get('constant.ADD') . ' ' . Config::get('constant.GROUP'))
@section('section')
@include('alerts.errors')
@include('alerts.success')

<form action="{{action('CategoriesController@saveGroup')}}" method="POST" class="form-horizontal margin-left-20" role="form">
    ...
    <div id="wrapper" >
        <div class="row margin-form">
            ...
            <div class="col-sm-12 height-45-frm">
                ...
                <div class="col-xs-9 col-sm-4 form-group">
                    <input type="text" placeholder=" vd: G1" class="form-control" id="txtGroupCode" name="group_code" required>
                </div>
            ...
            <div class="col-sm-12 height-45-frm">
                ...
                <div class="col-xs-9 col-sm-4 form-group">
                    <input type="text" placeholder=" vd: Nhóm 1" class="form-control" name="group_name" required>
                </div>
                <div class="col-xs-3 col-sm-6"></div>
            </div>
