...
@section('page_heading','Thêm Mới Kế Hoạch Cho Nhân Viên')
@section('section')
    ...
    <div id="wrapper" >
        <div class="row margin-form">
            ...
            <div class="col-sm-12">
                <div class="col-sm-2 control-label padding-top-frm padding-right-15 font-label-form text-right">Nhân viên:</div>
                <div class="col-sm-4 form-group">
                    <select class="form-control combobox-99" id="sel1">
            ...
            <div class="col-sm-12">
                ...
                <div class="col-sm-4 form-group">
                    <input type="number" class="form-control combobox-99" id="goal" readonly value="3">
                </div>
                <div class="col-sm-6"></div>
            </div>
            ...
            <div class="col-sm-12">
                ...
                <div class="col-sm-4 form-group">
                    ...
                    <a href="<?=URL::to('manageGoalEmployee') ;?>"><button type="button" class="btn btn-primary btn-cancel"> <i class="fa fa-reply"></i> Bỏ qua</button></a>
                </div>
                <div class="col-sm-6"></div>
            </div>
