...
@section('page_heading','Thêm Mới Trọng Số Cho Công Ty')
@section('section')
        ...
        <div class="row margin-form">
            ...
            <div class="col-sm-12">
                ...
                <div class="col-sm-4 form-group">
                    ...
                    <a href="<?=URL::to('managePriorityCorporation');?>"><button type="button" class="btn btn-primary btn-cancel"> <i class="fa fa-reply"></i> Bỏ qua</button></a>
                </div>
                <div class="col-sm-6"></div>
            </div>
