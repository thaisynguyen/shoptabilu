...
(function (C, Y) {
    ...
    u.stop = Pa;
    O = {
        colors: "#87CEEB,#9370D8,#FFB6C1,#90EE90".split(","),
    ...
    Ba.prototype = {
        Element: Q, init: function (a, b, c, d, e, f) {
            ...
            this.createElement("desc").add().element.appendChild(z.createTextNode(""));
            ...
            return a[0] + a[1] + a[2] > 384 ? "#000000" : "#FFFFFF"
                             ...
                             b, c, d, e, f, g, h, i) {
            var k = this.label(a, b, c, i, null, null, null, null, "button"), j = 0, m, l, n, t, r, p, a = {
                x1: 0,
                y1: 0,
                x2: 0,
                y2: 1
            ...
            return a
                           ...
                           b, c, d, e, f) {
            var e = Z(a) ? a.r : e, g = this.createElement("rect"), a = Z(a) ? a : a === B ? {} : {
                x: a,
                y: b,
                width: s(c, 0),
                height: s(d, 0)
    ...
    Wa.prototype = {
        addLabel: function () {
            ...
            if (l && y)w === "inside" && (y = -y), d.opposite && (y = -y), h = this.getMarkPath(u, v, y, l * A, g, f), n ? n.animate({
                d: h,
                opacity: c
            }) : this.mark = f.path(h).attr({stroke: x, "stroke-width": l, opacity: c}).add(d.axisGroup);
    ...
    R.prototype = {
        ...
        drawPoints: function () {
            ...
            if (m.enabled !== !1 || this._hasPointMarkers)for (f = b.length; f--;)if (g = b[f], d = S(g.plotX), e = g.plotY, j = g.graphic, n = g.marker || {}, o = !!g.marker, a = s && n.enabled === B || n.enabled, r = g.isInside, a && e !== B && !isNaN(e) && g.y !== null)if (a = g.pointAttr[g.selected ? "select" : ""] || l, h = a.r, i = p(n.symbol, this.symbol), k = i.indexOf("url") === 0, j)j[r ? "hide" : "hide"](!0).animate(v({
                x: d - h,
                y: e - h
    ...
    v(hb.prototype, {
        addSeries: function (a, b, c) {
            ...
            if (!b.loadingShown)M(d, {
                opacity: 0,
                display: ""
            }), Xa(d, {opacity: e.style.opacity}, {duration: e.showDuration || 0}), b.loadingShown = !0;
            f()
