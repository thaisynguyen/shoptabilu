...
(function (d) {
    ...
    d.SVGRenderer.prototype.cuboidPath = function (c) {
        ...
        var a = c.x, e = c.y, f = c.z, g = c.height, h = c.width, j = c.depth, k = d.map, i = [{
            ...
            y: e,
            z: f + j
        }], i = r(i, d.charts[this.chartIndex], c.insidePlotArea), f = function (a, c) {
    ...
    d.wrap(d.Axis.prototype, "render", function (c) {
        ...
        if (this.chart.is3d()) {
            ...
            if (!this.isZAxis)this.horiz ? (h = {
                ...
                x: l + (b.yAxis[0].opposite ? i : -d.size),
                y: m + (b.xAxis[0].opposite ? -g.size : 0),
                z: 0,
                width: d.size,
                height: k + g.size,
    ...
    d.wrap(d.Axis.prototype, "getTitlePosition", function (c) {
        ...
        if (b)a = r([this.swapZ({
            ...
            y: a.y,
            z: 0
        })], this.chart, !1)[0], a[this.horiz ? "y" : "x"] += (this.horiz ? 1 : -1) * (this.opposite ? -1 : 1) * d, this.axisTitleMargin =
            d;
        return a
    });
    ...
    d.wrap(d.seriesTypes.pie.prototype, "translate", function (c) {
        ...
        if (this.chart.is3d()) {
            ...
            B(b.data, function (c) {
                ...
                f = (f.end + f.start) / 2;
                c.slicedTranslation = {
                    translateX: L(m(f) * a.slicedOffset * m(g * A)),
                    translateY: L(p(f) * a.slicedOffset * m(g * A))
                }
            })
        }
    });
