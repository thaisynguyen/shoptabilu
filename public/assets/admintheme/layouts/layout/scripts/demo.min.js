var Demo = function () {
    var e = function () {
        ...
        var a = function () {
            ...
            var t = $(".layout-option", e).val(), i = $(".sidebar-option", e).val(), d = $(".page-header-option", e).val(), r = $(".page-footer-option", e).val(), s = $(".sidebar-pos-option", e).val(), n = $(".sidebar-style-option", e).val(), p = $(".sidebar-menu-option", e).val(), l = $(".page-header-top-dropdown-style-option", e).val();
