            ...
            if (!(App.getViewPort().width >= t && !$(".page-sidebar-menu").attr("data-initialized") && $("body").hasClass("page-sidebar-closed") && 1 === a.parent("li").parent(".page-sidebar-menu").size())) {
                ...
                if (!(App.getViewPort().width >= t && 1 === a.parents(".page-sidebar-menu-hover-submenu").size())) {
                    ...
                    if (!a.next().hasClass("sub-menu always-open")) {
                        var o = a.parent().parent(), n = a, r = $(".page-sidebar-menu"), d = a.next(), l = r.data("auto-scroll"), p = parseInt(r.data("slide-speed")), c = r.data("keep-expanded");
                        ...
                        d.is(":visible") ? ($(".arrow", n).removeClass("open"), n.parent().removeClass("open"), d.slideUp(p, function () {
                            l === !0 && $("body").hasClass("page-sidebar-closed") === !1 && ($("body").hasClass("page-sidebar-fixed") ? r.slimScroll({scrollTo: n.position().top}) : App.scrollTo(n, h)), i()
