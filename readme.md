...
http://laravel.com/docs/5.1/helpers

##Install laravel 

composer create-project laravel/laravel {directory} 5.1 --prefer-dist

##Update phpexcel in composer 
composer self-update
composer require --prefer-dist phpoffice/phpexcel "1.7.9"
...
##Autoload custom class
1) In composer.json -> add "files": ["app/Utils/commonUtils.php"].
    "autoload": {
            "classmap": [
                "database"
            ],
...
2) Tools > Run Command >Type: composer dump-autoload
3) config/app.php
      
    'aliases' => [
      //'dateHelper'=> 'App\Helpers\DateHelper', //for Laravel 5.0
      'CommonUtils'   => 'App\Utils\commonUtils::commonUtils', //for Laravel 5.1
    ] 
## Artisan
D:\xampp-5.6\htdocs\itt-kpi\trunk\kpi\src>php artisan make:controller LogController
D:\xampp-5.6\htdocs\itt-kpi\trunk\kpi\src>php artisan make::request LoginRequest
